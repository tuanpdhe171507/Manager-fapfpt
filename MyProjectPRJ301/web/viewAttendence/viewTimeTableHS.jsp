    ...
    <body>
        <form action="">
            <div class="container">
                <div class="row cc">
                    <div class="col-md-6">
                        <h1 class="text6">FPT University Academic Portal</h1>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="container">
            ...
            <div class="text-container">
                ...
                <div class="text8">
                    <h6 class="text88">: These activities do not include extra-curriculum activities, such as club activities ...</h6>
                </div>
            </div>
            <div class="text-container">
                <div class="text8">
                ...
                <div class="text8">
                    <h6 class="text88">: Các hoạt động trong bảng dưới không bao gồm hoạt động ngoại khóa, ví dụ như hoạt động câu lạc bộ ...</h6>
                </div>
                <div class="text88"><h6>Các phòng bắt đầu bằng AL thuộc tòa nhà Alpha. VD: AL...</h6></div>
                <div class="text88"><h6>Các phòng bắt đầu bằng BE thuộc tòa nhà Beta. VD: BE,..</h6></div>
                <div><h6>Các phòng bắt đầu bằng G thuộc tòa nhà Gamma. VD: G201,...</h6></div>
                <div><h6>Các phòng tập bằng đầu bằng R thuộc khu vực sân tập Vovinam.</h6></div>
                <div><h6>Các phòng bắt đầu bằng DE thuộc tòa nhà Delta. VD: DE,..</h6></div>
                <div class="text89"><h6>Little UK (LUK) thuộc tầng 5 tòa nhà Delta</h6></div>
            </div>
            ...
            <table>
                <tr>
                    <th rowspan="2" class="text5">
                        ...
                        WEEK:<select name="weekday" onchange="document.getElementById('cc')">
                            <c:forEach items="${requestScope.dayAndMonth}" var="week">
                                <option value="${week.id}" 
                                        <c:if test="${week.id eq dayMonth}">
                                            selected="selected"
                                        </c:if>>
                                    ${week.getWeekRange()} 
                                </option>
                ...
                <c:forEach begin="1" end="12" var="slotNumber"> 
                    <tr>
                        <td>
                            Slot ${slotNumber}
                        </td>
                        <!-- Add additional td elements as needed -->
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
            ...
            <div class="text-container">
                ...
                <div class="text8 text88">
                    <h6 class="t100">.</h6>
                </div>
                <div class="text8">
                    <h6 class="t101">(attended)</h6>
                </div>
                <div class="text8">
                    <h6>: tuanpdhe171507 had attended this activity / Phan Đình Tuấn đã tham gia hoạt động này</h6>
                </div>
            </div>
            <div class="text-container">
                ...
                <div class="text8">
                    <h6 class="t102">(absent)</h6>
                </div>
                <div class="text8">
                    <h6>: tuanpdhe171507 had NOT attended this activity / Phan Đình Tuấn đã vắng mặt buổi này</h6>
                </div>
            </div>
            <div class="text-container">
                ...
                <div class="text8">
                    <h6>(-): no data was given / chưa có dữ liệu</h6>
                </div>
            </div>
