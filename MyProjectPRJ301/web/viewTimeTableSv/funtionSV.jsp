                ...
                <div class="col-md-6">
                    <div class="ht1">
                        ...
                        <div class="text3">
                            ...
                            <div><a href="timetablesinhvien">.Weekly timetable</a>(Thời khóa biểu từng tuần)</div>
                            
                            <div><a href="attendanceSV">.Attendance report </a>(Báo cáo điểm danh)</div>
                            <div><a href="marksv">.Mark Report</a> (Báo cáo điểm)</div>
                        </div>
                    </div>
                </div>
            </div>
