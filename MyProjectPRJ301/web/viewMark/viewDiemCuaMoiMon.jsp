<%-- 
    Document   : markEachSubject
    Created on : Feb 26, 2024, 1:57:32 AM
    Author     : G5 5590
--%>
    ...
    <body>
        <form action="viewmark">
            ...
            <table class="bang">
                ...
                <tr>
                    <th class="text5 tuan">GRADE CATEGORY</th>
                    <th class="text6 tuan">GRADE ITEM</th>
                    <th class="text10 tuan">WEIGHT</th>
                    <th class="tuan">VALUE</th>
                    <th class="text11 tuan">COMMENT</th>
                </tr>
