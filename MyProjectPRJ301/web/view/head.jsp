<%-- 
    Document   : head
    Created on : Feb 24, 2024, 1:11:56 PM
    Author     : G5 5590
--%>
...
<html>
    ...
    <body>
        <form id="cc" action="fapfpt" method="POST">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                ...
                <div class="row cc">
                    <div class="col-md-6">
                        <div class="ht">
                            <button class="text11" type="button">Phụ huynh</button>
                            <!-- Nội dung bên trong hình chữ nhật -->
                            <div class="additional-line"></div>

                            <button class="text2" type="button">Đăng nhập</button>

                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="ht1">
                            <button class="text11" type="button">Sinh viên,Giảng viên,Cán bộ ĐH-PFT</button>
                            <!-- Nội dung bên trong hình chữ nhật 2 -->

                            <div class="additional-line"></div>
                            <div class="t5">
                                <div class="container5">
                                    <select name="did" class="container6" id="campusSelect" onchange="document.getElementById('cc')">
                                ...
                                <div class="container5">
                                    <input class="text5" type="submit" value="G+  Login With Google"/>
                                </div>
                            </div>
                            <div>
                                <h6>Với sinh viên từ K19 đăng nhập với FEID</h6>
                            </div>
                            <div class="text6">
                                <input class="text7" type="submit" value="&#x2709;  Login With FeID"/>
                            </div>  
                ...
                <div class="additional-line1"></div>
                <div class="text3">
                    <div class="circle-wrapper text3">
                        <h5>c</h5>
                    </div>
                    <div class="text3">
                        <h5>Powered by</h5>&nbsp;&nbsp;
                        <h5 class="text4">FPT University| CMS| library| books24x7</h5>
                    </div>
                </div>
                <div class="additional-line2"></div>
            </div>
